...
def launch(mutation, pmx_resnum, ligand, wt_replica, mut_replica, queue, num_nodes, compss_version, fe_nsteps, fe_length,
    ...
    if apo:
        template_yaml_path = base_dir.joinpath('PMX', 'pmxlaunch', 'dev', 'workflows', 'APO', 'pmx_apo.yaml')
        template_py_path = base_dir.joinpath('PMX', 'pmxlaunch', 'dev', 'workflows', 'APO', 'pmx_apo.py')
    else:
        template_yaml_path = base_dir.joinpath('PMX', 'pmxlaunch', 'dev', 'workflows', 'HOLO', 'pmxLig.yaml')
        template_py_path = base_dir.joinpath('PMX', 'pmxlaunch', 'dev', 'workflows', 'HOLO', 'pmxLig.py')
